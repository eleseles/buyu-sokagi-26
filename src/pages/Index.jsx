...
import { Sparkles, Moon, Sun, Wand2, Heart, Compass } from 'lucide-react';
...
const FeatureCard = ({ icon: Icon, title, description, to }) => (
  ...
  >
    <Card className="bg-purple-900 bg-opacity-50 backdrop-blur-md text-white h-full">
      <CardHeader>
...
const Index = () => {
  const features = [
    ...
    { icon: Sparkles, title: "Tarot Falı", description: "Geleceğinizi tarot kartlarıyla keşfedin.", to: "/tarot-fali" },
